...
import { z } from 'zod';
import { User, Phone, MapPin, Calendar, Briefcase, Award, Train, Upload } from 'lucide-react';
    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="bg-blue-800 text-white p-6 text-center">
          ...
          <p className="text-blue-200">Please provide your employee details</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500 mt-2">Click the upload icon to add your profile picture</p>
          </div>
          ...
          <div className="flex justify-end">
            <button
              ...
              className="px-8 py-3 bg-blue-800 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 font-medium"
            >
